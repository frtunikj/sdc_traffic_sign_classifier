...
{\color{incolor}In [{\color{incolor}232}]:} \PY{c+c1}{\PYZsh{} Load pickled data}
          \PY{k+kn}{import} \PY{n+nn}{pickle}
          
          \PY{c+c1}{\PYZsh{} TODO: Fill this in based on where you saved the training and testing data}
          
          \PY{n}{training\PYZus{}file} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./traffic\PYZus{}sign\PYZus{}data/train.p}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{validation\PYZus{}file}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./traffic\PYZus{}sign\PYZus{}data/valid.p}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{testing\PYZus{}file} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./traffic\PYZus{}sign\PYZus{}data/test.p}\PY{l+s+s2}{\PYZdq{}}
...
Pandas}\label{provide-a-basic-summary-of-the-data-set-using-python-numpy-andor-pandas}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}233}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Replace each question mark with the appropriate value. }
          ...
          \PY{n}{image\PYZus{}shape} \PY{o}{=} \PY{n}{image\PYZus{}shape} \PY{o}{=} \PY{n}{X\PYZus{}train}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{shape}
          
          \PY{c+c1}{\PYZsh{} TODO: How many unique classes/labels there are in the dataset.}
          \PY{n}{n\PYZus{}classes} \PY{o}{=} \PY{n}{n\PYZus{}classes} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n+nb}{set}\PY{p}{(}\PY{n+nb}{list}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)} \PY{o}{+} \PY{n+nb}{list}\PY{p}{(}\PY{n}{y\PYZus{}valid}\PY{p}{)} \PY{o}{+} \PY{n+nb}{list}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{)}\PY{p}{)}\PY{p}{)}
...
the same? Are there more examples of some classes than others?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}234}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Data exploration visualization code goes here.}
          ...
          \PY{k}{def} \PY{n+nf}{showImages}\PY{p}{(}\PY{n}{images}\PY{p}{,} \PY{n}{its\PYZus{}gray} \PY{o}{=} \PY{k+kc}{False}\PY{p}{)}\PY{p}{:}    
              \PY{c+c1}{\PYZsh{} show random set of 15 (images\PYZus{}per\PYZus{}row/5*images\PYZus{}per\PYZus{}col/3) images}
              \PY{n}{images\PYZus{}per\PYZus{}row} \PY{o}{=} \PY{l+m+mi}{5}
              \PY{n}{images\PYZus{}per\PYZus{}col} \PY{o}{=} \PY{l+m+mi}{3}
              \PY{n}{number\PYZus{}of\PYZus{}images} \PY{o}{=} \PY{n}{images\PYZus{}per\PYZus{}row} \PY{o}{*} \PY{n}{images\PYZus{}per\PYZus{}col}
              
              \PY{n}{image\PYZus{}hight} \PY{o}{=} \PY{l+m+mi}{15}
              \PY{n}{image\PYZus{}width} \PY{o}{=} \PY{l+m+mi}{6}
              
              \PY{n}{figure}\PY{p}{,} \PY{n}{axis} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{n}{images\PYZus{}per\PYZus{}col}\PY{p}{,} \PY{n}{images\PYZus{}per\PYZus{}row}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{n}{image\PYZus{}hight}\PY{p}{,} \PY{n}{image\PYZus{}width}\PY{p}{)}\PY{p}{)}
              \PY{n}{figure}\PY{o}{.}\PY{n}{subplots\PYZus{}adjust}\PY{p}{(}\PY{n}{hspace} \PY{o}{=} \PY{o}{.}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{wspace}\PY{o}{=}\PY{o}{.}\PY{l+m+mi}{001}\PY{p}{)}
              \PY{n}{axis} \PY{o}{=} \PY{n}{axis}\PY{o}{.}\PY{n}{ravel}\PY{p}{(}\PY{p}{)}
              
              \PY{k}{for} \PY{n}{idx} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{number\PYZus{}of\PYZus{}images}\PY{p}{)}\PY{p}{:}
                  \PY{n}{index} \PY{o}{=} \PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{images}\PY{p}{)}\PY{p}{)}
                  \PY{n}{image} \PY{o}{=} \PY{n}{images}\PY{p}{[}\PY{n}{index}\PY{p}{]}
                  \PY{n}{axis}\PY{p}{[}\PY{n}{idx}\PY{p}{]}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{off}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                  \PY{k}{if} \PY{n}{its\PYZus{}gray}\PY{p}{:}
                      \PY{n}{axis}\PY{p}{[}\PY{n}{idx}\PY{p}{]}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{32}\PY{p}{)}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{gray}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                  \PY{k}{else}\PY{p}{:}
                      \PY{n}{axis}\PY{p}{[}\PY{n}{idx}\PY{p}{]}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image}\PY{p}{)}
          
                      
          \PY{k}{def} \PY{n+nf}{plotHistogram}\PY{p}{(}\PY{n}{data}\PY{p}{,} \PY{n}{set\PYZus{}name}\PY{p}{)}\PY{p}{:}
              \PY{c+c1}{\PYZsh{} plot histogram of the list of data using the set\PYZus{}name as title for the graphs }
              \PY{n}{class\PYZus{}list} \PY{o}{=} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n\PYZus{}classes}\PY{p}{)}
              \PY{n}{label\PYZus{}list} \PY{o}{=} \PY{n}{data}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
              \PY{n}{class\PYZus{}counts} \PY{o}{=} \PY{p}{[}\PY{n}{label\PYZus{}list}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{n}{i}\PY{p}{)} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{class\PYZus{}list}\PY{p}{]}
              \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{class\PYZus{}list}\PY{p}{,} \PY{n}{class\PYZus{}counts}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{n}{set\PYZus{}name}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)} 
              
          
          \PY{n}{showImages}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}235}]:} \PY{n}{plotHistogram}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{set\PYZus{}name} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{TRAINING SET: number of data points per class}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)} 
          \PY{n}{plotHistogram}\PY{p}{(}\PY{n}{y\PYZus{}valid}\PY{p}{,} \PY{n}{set\PYZus{}name} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{VALIDATION SET: number of data points per class}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{plotHistogram}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{set\PYZus{}name} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{TEST SET: number of data points per class}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)} 
\end{Verbatim}
...
the first step of your project.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}236}]:} \PY{k}{def} \PY{n+nf}{preprocessImages}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{equalize\PYZus{}hist}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}\PY{p}{:}
          
              \PY{c+c1}{\PYZsh{} convert from RGB to YUV }
              \PY{n}{X} \PY{o}{=} \PY{l+m+mf}{0.299} \PY{o}{*} \PY{n}{X}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]} \PY{o}{+} \PY{l+m+mf}{0.587} \PY{o}{*} \PY{n}{X}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]} \PY{o}{+} \PY{l+m+mf}{0.114} \PY{o}{*} \PY{n}{X}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{]}
              
              \PY{c+c1}{\PYZsh{} adjust image contrast}
              \PY{k}{if} \PY{n}{equalize\PYZus{}hist}\PY{p}{:}
                  \PY{n}{X} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{cv2}\PY{o}{.}\PY{n}{equalizeHist}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{uint8}\PY{p}{(}\PY{n}{img}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)} \PY{k}{for} \PY{n}{img} \PY{o+ow}{in} \PY{n}{X}\PY{p}{]}\PY{p}{)}
          
              \PY{n}{X} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{float32}\PY{p}{(}\PY{n}{X}\PY{p}{)}
          
              \PY{c+c1}{\PYZsh{} normalize data to mean and std. deviation}
              \PY{n}{X} \PY{o}{\PYZhy{}}\PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
              \PY{n}{X} \PY{o}{/}\PY{o}{=} \PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{std}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)} \PY{o}{+} \PY{n}{np}\PY{o}{.}\PY{n}{finfo}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{float32}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{eps}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}237}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Preprocess the data here. It is required to normalize the data. Other preprocessing steps could include }
          \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} converting to grayscale, etc.}
          \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
          
          \PY{n}{X\PYZus{}train\PYZus{}rgb} \PY{o}{=} \PY{n}{X\PYZus{}train}
          \PY{n}{X\PYZus{}train\PYZus{}prep} \PY{o}{=} \PY{n}{preprocessImages}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}
          
          \PY{n}{X\PYZus{}valid\PYZus{}rgb} \PY{o}{=} \PY{n}{X\PYZus{}valid}
          \PY{n}{X\PYZus{}valid\PYZus{}prep} \PY{o}{=} \PY{n}{preprocessImages}\PY{p}{(}\PY{n}{X\PYZus{}valid}\PY{p}{)}
          
          \PY{n}{X\PYZus{}test\PYZus{}rgb} \PY{o}{=} \PY{n}{X\PYZus{}test}
          \PY{n}{X\PYZus{}test\PYZus{}prep} \PY{o}{=} \PY{n}{preprocessImages}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{)}
          ...
          \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Grayscale shape:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}prep}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
          
          \PY{n}{showImages}\PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}prep}\PY{p}{,} \PY{n}{its\PYZus{}gray} \PY{o}{=} \PY{k+kc}{True}\PY{p}{)} 
          
          \PY{n}{X\PYZus{}train} \PY{o}{=} \PY{n}{X\PYZus{}train\PYZus{}prep}
          \PY{n}{X\PYZus{}valid} \PY{o}{=} \PY{n}{X\PYZus{}valid\PYZus{}prep}
          \PY{n}{X\PYZus{}test} \PY{o}{=} \PY{n}{X\PYZus{}test\PYZus{}prep} 
\end{Verbatim}
...
Grayscale shape: (34799, 32, 32, 1)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}238}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{utils} \PY{k}{import} \PY{n}{shuffle}
...
\subsubsection{Model Architecture}\label{model-architecture}}
    ...
    \hypertarget{adopted-lenet-5-implementation-shown-in-the-classroom}{%
\paragraph{\texorpdfstring{Adopted LeNet-5 implementation shown in the
\href{https://classroom.udacity.com/nanodegrees/nd013/parts/fbf77062-5703-404e-b60c-95b78b2f3f9e/modules/6df7ae49-c61c-4bb2-a23e-6527e69209ec/lessons/601ae704-1035-4287-8b11-e2c2716217ad/concepts/d4aca031-508f-4e0b-b493-e7b706120f81}{classroom}}{Adopted LeNet-5 implementation shown in the classroom}}\label{adopted-lenet-5-implementation-shown-in-the-classroom}}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}239}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Define your architecture here.}
          \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
          ...
          \PY{k}{def} \PY{n+nf}{LeNet}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}    
              ...
              \PY{n}{fc1} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{dropout}\PY{p}{(}\PY{n}{fc1}\PY{p}{,} \PY{n}{dropout\PYZus{}prob}\PY{p}{)}
              ...
              \PY{c+c1}{\PYZsh{} Dropout}
              \PY{n}{fc2} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{dropout}\PY{p}{(}\PY{n}{fc2}\PY{p}{,} \PY{n}{dropout\PYZus{}prob}\PY{p}{)}
              ...
              \PY{k}{return} \PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{n}{conv1}\PY{p}{,} \PY{n}{conv2}\PY{p}{,} \PY{n}{fc1}\PY{p}{,} \PY{n}{fc2}\PY{p}{)}
\end{Verbatim}


    \hypertarget{lenet-according-to-the-published-baseline-model-on-this-problem}{%
\subsubsection{\texorpdfstring{LeNet according to the
\href{http://yann.lecun.com/exdb/publis/pdf/sermanet-ijcnn-11.pdf}{published
baseline model on this
problem}}{LeNet according to the published baseline model on this problem}}\label{lenet-according-to-the-published-baseline-model-on-this-problem}}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}240}]:} \PY{k+kn}{from} \PY{n+nn}{tensorflow}\PY{n+nn}{.}\PY{n+nn}{contrib}\PY{n+nn}{.}\PY{n+nn}{layers} \PY{k}{import} \PY{n}{flatten}
          
          \PY{k}{def} \PY{n+nf}{LeNetPaper}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}    
              ...
              \PY{c+c1}{\PYZsh{} SOLUTION: Pooling. Input = 10x10x16. Output = 5x5x16.}
              \PY{n}{conv2} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{max\PYZus{}pool}\PY{p}{(}\PY{n}{conv2}\PY{p}{,} \PY{n}{ksize}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{padding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{VALID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
              \PY{n}{layer2} \PY{o}{=} \PY{n}{conv2}
          
              \PY{c+c1}{\PYZsh{} SOLUTION: Layer 3: Convolutional. Output = 10x10x16.}
              ...
              \PY{n}{layer3} \PY{o}{=} \PY{n}{conv3}
          
              \PY{c+c1}{\PYZsh{} TODO: Flatten. Input = 5x5x16. Output = 400.}
              \PY{n}{layer2flat} \PY{o}{=} \PY{n}{flatten}\PY{p}{(}\PY{n}{layer2}\PY{p}{)}
              \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{layer2flat shape:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{layer2flat}\PY{o}{.}\PY{n}{get\PYZus{}shape}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              
              \PY{c+c1}{\PYZsh{} Flatten x. Input = 1x1x400. Output = 400.}
              \PY{n}{xflat} \PY{o}{=} \PY{n}{flatten}\PY{p}{(}\PY{n}{conv3}\PY{p}{)}
              \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{xflat shape:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{xflat}\PY{o}{.}\PY{n}{get\PYZus{}shape}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              
              \PY{c+c1}{\PYZsh{} Concat layer2flat and x. Input = 400 + 400. Output = 800}
              \PY{n}{x} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{concat\PYZus{}v2}\PY{p}{(}\PY{p}{[}\PY{n}{xflat}\PY{p}{,} \PY{n}{layer2flat}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
              \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{x shape:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{x}\PY{o}{.}\PY{n}{get\PYZus{}shape}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              
              \PY{c+c1}{\PYZsh{} Dropout}
              \PY{n}{x} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{dropout}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{dropout\PYZus{}prob}\PY{p}{)}
              
              \PY{c+c1}{\PYZsh{} SOLUTION: Layer 4: Fully Connected. Input = 800. Output = 43.}
              \PY{n}{fc3\PYZus{}W}  \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{n}{shape}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{800}\PY{p}{,} \PY{l+m+mi}{43}\PY{p}{)}\PY{p}{,} \PY{n}{mean} \PY{o}{=} \PY{n}{mu}\PY{p}{,} \PY{n}{stddev} \PY{o}{=} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
              \PY{n}{fc3\PYZus{}b}  \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{l+m+mi}{43}\PY{p}{)}\PY{p}{)}
              \PY{n}{logits} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{matmul}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{fc3\PYZus{}W}\PY{p}{)} \PY{o}{+} \PY{n}{fc3\PYZus{}b}
              
              \PY{k}{return} \PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{n}{conv1}\PY{p}{,} \PY{n}{conv2}\PY{p}{,} \PY{n}{conv3}\PY{p}{)}
\end{Verbatim}
...
implies overfitting.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}241}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Train your model here.}
          ...
          \PY{n}{dropout\PYZus{}prob} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{placeholder}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{float32}\PY{p}{)}
          \PY{n}{one\PYZus{}hot\PYZus{}y} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{one\PYZus{}hot}\PY{p}{(}\PY{n}{y}\PY{p}{,} \PY{l+m+mi}{43}\PY{p}{)} 
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}242}]:} \PY{n}{rate} \PY{o}{=} \PY{l+m+mf}{0.001}
          
          \PY{c+c1}{\PYZsh{}logits, conv1, conv2, fc1, fc2 = LeNet(x)}
          \PY{n}{logits}\PY{p}{,} \PY{n}{conv1}\PY{p}{,} \PY{n}{conv2}\PY{p}{,} \PY{n}{conv3} \PY{o}{=} \PY{n}{LeNetPaper}\PY{p}{(}\PY{n}{x}\PY{p}{)}
...
x shape: (?, 800)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}243}]:} \PY{n}{correct\PYZus{}prediction} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{equal}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{one\PYZus{}hot\PYZus{}y}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
          ...
          \PY{k}{def} \PY{n+nf}{evaluate}\PY{p}{(}\PY{n}{X\PYZus{}data}\PY{p}{,} \PY{n}{y\PYZus{}data}\PY{p}{)}\PY{p}{:}
              ...
              \PY{k}{for} \PY{n}{offset} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{num\PYZus{}examples}\PY{p}{,} \PY{n}{BATCH\PYZus{}SIZE}\PY{p}{)}\PY{p}{:}
                  ...
                  \PY{n}{accuracy} \PY{o}{=} \PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{accuracy\PYZus{}operation}\PY{p}{,} \PY{n}{feed\PYZus{}dict}\PY{o}{=}\PY{p}{\PYZob{}}\PY{n}{x}\PY{p}{:} \PY{n}{batch\PYZus{}x}\PY{p}{,} \PY{n}{y}\PY{p}{:} \PY{n}{batch\PYZus{}y}\PY{p}{,} \PY{n}{dropout\PYZus{}prob}\PY{p}{:} \PY{l+m+mf}{1.0}\PY{p}{\PYZcb{}}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}244}]:} \PY{n}{epoch\PYZus{}validation} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{n}{EPOCHS}\PY{p}{)}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{float64}\PY{p}{)}
          ...
          \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
              ...
              \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{EPOCHS}\PY{p}{)}\PY{p}{:}
                  ...
                  \PY{k}{for} \PY{n}{offset} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{num\PYZus{}examples}\PY{p}{,} \PY{n}{BATCH\PYZus{}SIZE}\PY{p}{)}\PY{p}{:}
                      ...
                      \PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{training\PYZus{}operation}\PY{p}{,} \PY{n}{feed\PYZus{}dict}\PY{o}{=}\PY{p}{\PYZob{}}\PY{n}{x}\PY{p}{:} \PY{n}{batch\PYZus{}x}\PY{p}{,} \PY{n}{y}\PY{p}{:} \PY{n}{batch\PYZus{}y}\PY{p}{,} \PY{n}{dropout\PYZus{}prob}\PY{p}{:} \PY{l+m+mf}{0.6}\PY{p}{\PYZcb{}}\PY{p}{)}
                      
                  \PY{n}{validation\PYZus{}accuracy} \PY{o}{=} \PY{n}{evaluate}\PY{p}{(}\PY{n}{X\PYZus{}valid}\PY{p}{,} \PY{n}{y\PYZus{}valid}\PY{p}{)}
                  \PY{n}{epoch\PYZus{}validation}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{validation\PYZus{}accuracy}
...
Model saved
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}245}]:} \PY{n}{fig}\PY{p}{,} \PY{n}{axes} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{n}{ncols}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{)}\PY{p}{)}
          \PY{n}{axes}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{EPOCHS} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{epoch\PYZus{}validation}\PY{p}{)}
          \PY{n}{axes}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Epochs}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{axes}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Accuracy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{axes}\PY{o}{.}\PY{n}{grid}\PY{p}{(}\PY{k+kc}{True}\PY{p}{)} 
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}246}]:} \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
...
Images}\label{load-and-output-the-images}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}247}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Load the images and plot them here.}
          \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
          \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
          \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline
          ...
          \PY{n}{fig}\PY{p}{,} \PY{n}{axs} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{15}\PY{p}{,} \PY{l+m+mi}{6}\PY{p}{)}\PY{p}{)}
          ...
          \PY{n}{my\PYZus{}set} \PY{o}{=} \PY{p}{[}\PY{p}{]}
          
          \PY{k}{for} \PY{n}{idx}\PY{p}{,} \PY{n}{img} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{glob}\PY{o}{.}\PY{n}{glob}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./my\PYZus{}examples/*.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}\PY{p}{:}
              \PY{n}{image} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{n}{img}\PY{p}{)}
              \PY{n}{image\PYZus{}resized} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{resize}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{32}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{)}\PY{p}{)}
              \PY{n}{axs}\PY{p}{[}\PY{n}{idx}\PY{p}{]}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{off}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
              \PY{n}{axs}\PY{p}{[}\PY{n}{idx}\PY{p}{]}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{cv2}\PY{o}{.}\PY{n}{cvtColor}\PY{p}{(}\PY{n}{image\PYZus{}resized}\PY{p}{,} \PY{n}{cv2}\PY{o}{.}\PY{n}{COLOR\PYZus{}BGR2RGB}\PY{p}{)}\PY{p}{)}
              \PY{n}{my\PYZus{}set}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{cv2}\PY{o}{.}\PY{n}{cvtColor}\PY{p}{(}\PY{n}{image\PYZus{}resized}\PY{p}{,} \PY{n}{cv2}\PY{o}{.}\PY{n}{COLOR\PYZus{}BGR2RGB}\PY{p}{)}\PY{p}{)}
              
          \PY{n}{my\PYZus{}set} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{my\PYZus{}set}\PY{p}{)}
          \PY{n}{my\PYZus{}set\PYZus{}gry} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{my\PYZus{}set}\PY{o}{/}\PY{l+m+mi}{3}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,} \PY{n}{keepdims}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
          \PY{n}{my\PYZus{}set\PYZus{}normalized} \PY{o}{=} \PY{p}{(}\PY{n}{my\PYZus{}set\PYZus{}gry} \PY{o}{\PYZhy{}} \PY{l+m+mi}{128}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{128} 
          \PY{n}{my\PYZus{}set\PYZus{}labels} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{36}\PY{p}{,} \PY{l+m+mi}{19}\PY{p}{,} \PY{l+m+mi}{12}\PY{p}{,} \PY{l+m+mi}{13}\PY{p}{]}\PY{p}{)}
          
          \PY{n}{test\PYZus{}image\PYZus{}featuremap} \PY{o}{=} \PY{n}{my\PYZus{}set\PYZus{}normalized}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{:}\PY{l+m+mi}{4}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{]}
          
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{my\PYZus{}set}\PY{o}{.}\PY{n}{shape}\PY{p}{,} \PY{n}{my\PYZus{}set\PYZus{}labels}\PY{o}{.}\PY{n}{shape}\PY{p}{)} 
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{test\PYZus{}image\PYZus{}featuremap}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\end{Verbatim}
...
Image}\label{predict-the-sign-type-for-each-image}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}248}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Run the predictions here and use the model to output the prediction for each image.}
          ...
          \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
              \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{latest\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
              \PY{n}{predicted} \PY{o}{=} \PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{feed\PYZus{}dict}\PY{o}{=}\PY{p}{\PYZob{}}\PY{n}{x}\PY{p}{:} \PY{n}{my\PYZus{}set\PYZus{}normalized}\PY{p}{,} \PY{n}{y}\PY{p}{:} \PY{n}{my\PYZus{}set\PYZus{}labels}\PY{p}{,} \PY{n}{dropout\PYZus{}prob}\PY{p}{:} \PY{l+m+mf}{1.0}\PY{p}{\PYZcb{}}\PY{p}{)}
              \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{predicted}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZlt{}\PYZhy{}predictions}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
              \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{my\PYZus{}set\PYZus{}labels}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZlt{}\PYZhy{}actual label}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
 [ 2 35 19 12 13] <-predictions
 [ 2 36 19 12 13] <-actual label
...
\subsubsection{Analyze Performance}\label{analyze-performance}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}249}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Calculate the accuracy for these 5 new images. }
          ...
          \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
              \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{latest\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
              \PY{n}{my\PYZus{}accuracy} \PY{o}{=} \PY{n}{evaluate}\PY{p}{(}\PY{n}{my\PYZus{}set\PYZus{}normalized}\PY{p}{,} \PY{n}{my\PYZus{}set\PYZus{}labels}\PY{p}{)}
...
notice \texttt{{[}3,\ 0,\ 5{]}} are the corresponding indices.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}250}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Print out the top five softmax probabilities for the predictions on the German traffic sign images found on the web. }
          \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
          \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
              \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{latest\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
              \PY{n}{predicted5} \PY{o}{=} \PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{top\PYZus{}k}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{softmax}\PY{p}{(}\PY{n}{logits}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{,} \PY{n}{feed\PYZus{}dict}\PY{o}{=}\PY{p}{\PYZob{}}\PY{n}{x}\PY{p}{:} \PY{n}{my\PYZus{}set\PYZus{}normalized}\PY{p}{,} \PY{n}{y}\PY{p}{:} \PY{n}{my\PYZus{}set\PYZus{}labels}\PY{p}{,} \PY{n}{dropout\PYZus{}prob}\PY{p}{:} \PY{l+m+mf}{1.0}\PY{p}{\PYZcb{}}\PY{p}{)}
              \PY{n+nb}{print}\PY{p}{(}\PY{n}{predicted5}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{.}\PY{n}{T}\PY{p}{)}
              \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{(top  5 predictions above) for each image}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
              
          \PY{n+nb}{print}\PY{p}{(}\PY{p}{)}    
          \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{probability for top 5 predictions for each image:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          
          \PY{k}{for} \PY{n}{idx} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{my\PYZus{}set\PYZus{}labels}\PY{p}{)}\PY{p}{)}\PY{p}{:}
              \PY{n+nb}{print}\PY{p}{(}\PY{n}{idx}\PY{p}{,} \PY{n}{predicted5}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{n}{idx}\PY{p}{]}\PY{o}{.}\PY{n}{T}\PY{p}{)}
          
          
          \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
              \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{latest\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
              \PY{n}{test\PYZus{}accuracy} \PY{o}{=} \PY{n}{evaluate}\PY{p}{(}\PY{n}{my\PYZus{}set\PYZus{}normalized}\PY{p}{,} \PY{n}{my\PYZus{}set\PYZus{}labels} \PY{p}{)}
              \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test Accuracy = }\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{test\PYZus{}accuracy}\PY{p}{)}\PY{p}{)} 
              
          \PY{c+c1}{\PYZsh{}plot the top5 probabilities}
          
          \PY{n}{fig}\PY{p}{,} \PY{n}{axs} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{my\PYZus{}set}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{15}\PY{p}{,} \PY{l+m+mi}{6}\PY{p}{)}\PY{p}{)}
          ...
          \PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{n}{image} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{my\PYZus{}set}\PY{p}{)}\PY{p}{:}
              ...
              \PY{n}{guess1} \PY{o}{=} \PY{n}{predicted5}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
              \PY{n}{index1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{argwhere}\PY{p}{(}\PY{n}{y\PYZus{}valid} \PY{o}{==} \PY{n}{guess1}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
              ...
              \PY{n}{axs}\PY{p}{[}\PY{l+m+mi}{4}\PY{o}{*}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{top guess: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ (}\PY{l+s+si}{\PYZob{}:.0f\PYZcb{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{)}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{guess1}\PY{p}{,} \PY{l+m+mi}{100}\PY{o}{*}\PY{n}{predicted5}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
              \PY{n}{guess2} \PY{o}{=} \PY{n}{predicted5}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
              ...
              \PY{n}{axs}\PY{p}{[}\PY{l+m+mi}{4}\PY{o}{*}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{2}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{2nd guess: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ (}\PY{l+s+si}{\PYZob{}:.0f\PYZcb{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{)}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{guess2}\PY{p}{,} \PY{l+m+mi}{100}\PY{o}{*}\PY{n}{predicted5}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
              \PY{n}{guess3} \PY{o}{=} \PY{n}{predicted5}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
              ...
              \PY{n}{axs}\PY{p}{[}\PY{l+m+mi}{4}\PY{o}{*}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{3}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{3rd guess: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ (}\PY{l+s+si}{\PYZob{}:.0f\PYZcb{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{)}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{guess3}\PY{p}{,} \PY{l+m+mi}{100}\PY{o}{*}\PY{n}{predicted5}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}\PY{p}{)} 
\end{Verbatim}
...
Your output should look something like this (above)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}252}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Visualize your network\PYZsq{}s feature maps here.}
          \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}253}]:} \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
              \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{latest\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}   
              \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{conv1 : First layer}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
              \PY{n}{outputFeatureMap}\PY{p}{(}\PY{n}{test\PYZus{}image\PYZus{}featuremap}\PY{p}{,} \PY{n}{conv1}\PY{p}{)} 
...
conv1 : First layer
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}254}]:} \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
              \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{latest\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}   
              \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{conv2 : Second layer}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
              \PY{n}{outputFeatureMap}\PY{p}{(}\PY{n}{test\PYZus{}image\PYZus{}featuremap}\PY{p}{,} \PY{n}{conv2}\PY{p}{)} 
\end{Verbatim}
